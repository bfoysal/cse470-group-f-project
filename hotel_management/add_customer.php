		...
		<div class="wrapper">
			...
			<div class="sidebar-left sidebar-nicescroller">
				<ul class="sidebar-menu">
					...
					<li>
						...
						<ul class="submenu">
							<li><a href="add_customer.php">Customer Form <span class="label label-success span-sidebar">CURRENT</span></a></li>							
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Customer Form</h1>
					<!-- End page heading -->
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="the-box">
							<h4 class="small-title">CUSTOMER REGISTRATION FORM</h4>								
								<form action="register_control.php" method="post" autocomplete="on"> 
                                <p> 
                                    <label> First Name</label>
                                    <input id="fname" name="fname" type="text" placeholder="Abu" class="form-control" />
                                </p>
								<p> 
                                    <label> Last Name</label>
                                    <input id="lname" name="lname" required="required" type="text" placeholder="Foysal" class="form-control"/>
                                </p>
                                <p> 
                                    <label> Your email</label>
                                    <input id="email" name="email" required="required" type="email" placeholder="abu.foysal07@mail.com" class="form-control"/> 
                                </p>
								<p> 
                                    <label> Gender</label>
								...
								<p> 
                                    ...
                                    <input id="address" name="address" required="required" placeholder="Mirpur" type="text" class="form-control"/> 
                                </p>
								<p> 
                                    <label> Your Phone</label>
                                    <input id="phone" name="phone" required="required" placeholder="911" type="text" class="form-control"/> 
                                </p>
								<p> 
                                    <label> Credit Card No.</label>
                                    <input id="credit" name="credit" required="required" placeholder="1111111111111111" type="text" class="form-control"/> 
                                </p>
                                <p> 
                                    <label>Your password </label>
                                    <input id="passwordsignup" name="passwordsignup" required="required" type="password" placeholder="eg. X8df!90EO" class="form-control"/>
                                </p>
                                <p class="signin button"> 
									<button type="submit" class="btn btn-danger"><i class="fa fa-sign-in"></i> CREATE</button>
								</p>
                            </form>
							</div><!-- /.the-box -->
