		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Add Food <small></small></h1>
					<!-- End page heading -->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="the-box">
								<h4 class="small-title">Add Food</h4>
								<form role="form" action="add_food_ctrl.php" method="post">
								<div class="form-group lg left-feedback no-label">
								  ...
								  <select class="form-control" name="food_name">
										<option>Happy Morning</option>
										<option>Breakfast Delight</option>
										<option>Sea Food Delight</option>
										<option>Kashmiri Palate</option>
										<option>Dhakaiya Palate</option>
									</select>
								</div>
								<div class="form-group lg left-feedback no-label">
								...
								<div class="form-group lg left-feedback no-label">
								 ...
								 <p class="signin button"> 
									<button type="submit" class="btn btn-danger"><i class="fa fa-sign-in"></i> SUBMIT</button>
								</p>
							</form>
							</div><!-- /.the-box -->
						</div><!-- /.col-sm-8 -->
