		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Update Package <small></small></h1>
					<!-- End page heading -->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="the-box">
								...
								$sql="SELECT * FROM packages INNER JOIN room_price ON packages.pack_type=room_price.room_type WHERE pack_no='$pack_no'";
								$result=mysql_query($sql);
								...
								$active=$row['active'];
								?>
								<form role="form" action="edit_adv_ctrl.php" method="post">								
									<div class="form-group lg left-feedback">
									<label>Package Type</label>
									  <input type="hidden" name="pack_no" value="<?PHP echo $pack_no; ?>">
									  <input type="text" class="form-control" name="pack_type" value="<?PHP echo $pack_type; ?>">										  
									</div>
									<div class="form-group lg left-feedback">
									...
									echo '<option>'.$active.'</option>';
										$arrAct=array("Yes","No");
										foreach ($arrAct as $tmpAct) {
											if($tmpAct!=$active){
												echo '<option>'.$tmpAct.'</option>';
											}
										}
									?>
									</select>								
