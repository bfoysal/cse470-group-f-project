				...
				<ul class="sidebar-menu">
					...
					<li>
						...
						<ul class="submenu">
							...
							<li><a href="bill_services.php">Facilities <span class="label label-success span-sidebar">CURRENT</span></a></li>						
						</ul>
					</li>
				</ul>
			</div><!-- /.sidebar-left -->
		...
		<!-- BEGIN PAGE CONTENT -->
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Customer List <small>Billing Facility</small></h1>
					<!-- End page heading -->
