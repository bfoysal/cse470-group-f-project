		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Notifications <small></small></h1>
					<!-- End page heading -->
					...
					<!-- End breadcrumb --><!-- Begin info color table -->
					<h4 class="small-title">Bookings</h4>
					<div class="the-box full no-border">
						<div class="table-responsive">
							<table class="table table-th-block table-info">
								<thead>
									<tr><th style="width: 30px;">ID:</th><th>Full name</th><th>Room No.</th><th>Address</th><th>Credit Card</th><th>Phone</th><th>Status</th></tr>
								</thead>
								<tbody>
								<?PHP
								$sql="SELECT * FROM customer INNER JOIN rooms ON customer.cust_id=rooms.cust_id WHERE status='booked'";
								$result=mysql_query($sql);
								if (mysql_num_rows($result) > 0) {	
									while ($row = mysql_fetch_array($result)) {	
										...
										echo'<tr>
												...
												<td>'.$credit.'</td>
												<td>'.$phone_no.'</td>
												<td><a href="approve_book.php?room_no='.$room_no.'&cust_id='.$cust_id.'"><span class="label label-danger">Approve</span></a></td>
											 </tr>';
									 }
								 }
								 ?>															
