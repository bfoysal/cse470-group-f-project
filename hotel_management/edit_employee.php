		...
		<div class="wrapper">
			...
			<div class="page-content">
				...
				<div class="container-fluid">
					<!-- Begin page heading -->
					<h1 class="page-heading">Employee Form <small></small></h1>
					<!-- End page heading -->
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="the-box">
								<h4 class="small-title">UPDATE EMPLOYEE</h4>
								<?PHP
								$emp_id=$_GET['emp_id'];
								...
								<div class="form-group text-center">
									<img src="assets/img/avatar/<?PHP echo $emp_pic; ?>" class="avatar-lock img-circle" alt="Avatar">
								</div>
								<div class="form-group lg left-feedback no-label">
								  <input type="hidden" name="emp_id" value="<?PHP echo $emp_id; ?>">
								  <input type="text" name="fname" class="form-control" placeholder="First Name" value="<?PHP echo $fname; ?>" autofocus>
								</div>
								<div class="form-group lg left-feedback no-label">
								...
								<div class="form-group lg left-feedback no-label">
								  <input type="password" name="password" class="form-control" placeholder="Enter new password" value="<?PHP echo $password; ?>">
								</div>
								<div class="form-group lg left-feedback no-label">
							    <select class="form-control" name="type">
							    <?PHP 
								echo '<option>'.$emp_type.'</option>';
									$ty=array("Manager","Laundry", "Room Service", "Janitor", "Receptionist");
									foreach ($ty as $tmpType) {
										if($tmpType!=$emp_type){
											echo '<option>'.$tmpType.'</option>';
										}
									}
								?>
								</select>								
								...
								<select class="form-control" name="gender">
									...
									echo '<option>'.$gender.'</option>';
										...
										foreach ($gen as $tmpGen) {
											if($tmpGen!=$gender){
												echo '<option>'.$tmpGen.'</option>';
											}
										}
									?>
								</select>
								...
								<div class="form-group lg left-feedback no-label">
								 ...
								 <p class="signin button"> 
									<button type="submit" class="btn btn-danger"><i class="fa fa-sign-in"></i> UPDATE</button>
								</p>
							</form>
							</div><!-- /.the-box -->
						</div><!-- /.col-sm-8 -->
